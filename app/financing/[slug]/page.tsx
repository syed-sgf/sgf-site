...
const goodFitMap: Record<string, string[]> = {
  ...
  "dscr-rental": ["Investors building long-term rental portfolios", "Properties with stable, documentable rental income", "Investors who prefer asset-based underwriting", "Landlords refinancing existing rental debt"],
...
const notFitMap: Record<string, string[]> = {
  ...
  "dscr-rental": ["Properties that are vacant with no lease in place", "Owner-occupied properties — not investor programs", "Borrowers needing fast close with no documentation", "Properties with below-market or subsidized rents"],
...
const structureMap: Record<string, string> = {
  ...
  "dscr-rental": "DSCR loans underwrite the property's rental income rather than the borrower's personal income. The debt service coverage ratio — net operating income divided by total debt service — must typically exceed 1.20x. These are long-term, fully amortizing loans structured like conventional mortgages.",
