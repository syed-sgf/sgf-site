...
// TODO: Replace REPLACE_LOAN_APPLICATION_FORM_ID with the real GHL form ID
...
const FORM_ID = "REPLACE_LOAN_APPLICATION_FORM_ID";
    ...
    <main style={{ fontFamily: G.sans, color: G.textDark }}>
      ...
      <section style={{ background: G.cream, padding: "4rem 1.5rem" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", background: "#fff",
          ...
          <iframe
            ...
            data-form-name="SGF Loan Application"
            data-height="600"
            data-layout-iframe-id={iframeId}
            data-form-id={FORM_ID}
            title="SGF Loan Application"
          />
      ...
      <section style={{ background: G.dark, padding: "3.5rem 2rem",
        ...
        <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.95rem",
          ...
          Browse our financing programs to understand which structure fits your situation.
        </p>
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="/financing-options" style={{ background: G.gold, color: G.dark,
