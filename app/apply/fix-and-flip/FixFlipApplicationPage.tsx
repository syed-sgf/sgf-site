...
const TABS = [
  { label: "Fix & Sell",    href: "/apply/fix-and-flip/fix-and-sell" },
  { label: "Fix & Hold",    href: "/apply/fix-and-flip/fix-and-hold" },
  { label: "Construction",  href: "/apply/fix-and-flip/construction" },
];

interface Props {
  formId: string;
  formName: string;
  activeTab: "fix-and-sell" | "fix-and-hold" | "construction";
  heading: string;
  subheading: string;
}

export default function FixFlipApplicationPage({
  formId,
  formName,
  activeTab,
  heading,
  ...
  return (
    <main style={{ fontFamily: G.sans, color: G.textDark }}>
      ...
      {/* Tab bar */}
      <div style={{ background: "#fff", borderBottom: `1px solid ${G.border}`, padding: "0 1.5rem" }}>
            ...
            return (
              <Link
                ...
                style={{
                  ...
                  fontWeight: 600,
                  textDecoration: "none",
                  color: isActive ? G.primary : G.textMid,
      ...
      <section style={{ background: G.cream, padding: "4rem 1.5rem" }}>
        <div style={{
          ...
          <iframe
            src={`https://api.leadconnectorhq.com/widget/form/${formId}${pageUrl ? `?url=${encodeURIComponent(pageUrl)}` : ""}`}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2rem" }}
            ...
            {[
              { step: "01", title: "Review",
                body: "We review your submission within one business day and assess program fit based on your project details." },
              { step: "02", title: "Conversation",
                body: "If there is a potential match, a member of our team will reach out to discuss your deal in more detail." },
              { step: "03", title: "Structure",
                body: "If we move forward, we will identify the right lender, terms, and help you prepare for a smooth close." },
            ].map(({ step, title, body }) => (
      ...
      <section style={{ background: G.dark, padding: "3.5rem 2rem",
        ...
        <h2 style={{ fontFamily: G.serif, fontSize: "clamp(1.3rem, 2.5vw, 1.8rem)",
          ...
          Learn More About Fix &amp; Flip Financing
        </h2>
        <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.95rem",
          maxWidth: 460, marginBottom: "2rem", lineHeight: 1.75 }}>
          Review program details, typical deal structures, and eligibility criteria before you apply.
        </p>
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="/financing-options/fix-and-flip" style={{ background: G.gold, color: G.dark,
