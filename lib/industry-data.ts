...
export const industries: Industry[] = [
  {
    ...
    commonFinancingNeeds: [
      ...
      "Construction financing for horizontal and vertical construction — for developers and builders",
      "Accounts receivable financing to accelerate contractor invoice collections",
      "Bridge loan funding for construction projects transitioning to permanent financing",
    ],
    relevantProducts: [
      "equipment-financing",
      "bridge-construction",
    ...
    keyStats: [
      { label: "Construction Loans", value: "$50K–$25M" },
